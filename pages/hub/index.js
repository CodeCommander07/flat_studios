    ...
    <AuthWrapper requiredRole="hub">
      <main className="text-white px-6 py-2 flex flex-col items-center">
        <div className="max-w-6xl w-full space-y-8">
          ...
          {/* Leaderboard */}
          <div className="bg-white/10 border backdrop-blur-md border-white/20 p-6 rounded-2xl shadow-md">
            <div className="flex items-center gap-3 mb-4">
              <Trophy className="w-6 h-6 text-orange-400" />
              <h2 className="text-xl font-semibold">Weekly Activity Leaderboard</h2>
            </div>
                ...
                <tbody>
                  {leaderboard.map((user, idx) => (
                    <tr key={idx} className="border-b border-white/10 hover:bg-white/5">
                      ...
                      <td className="py-2">{user.shifts}</td>
                      <td className="py-2">{user.time}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
