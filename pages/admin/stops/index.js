...
export default function AdminStopsPage() {
    ...
    // 🆕 When user clicks Add Stop
    const openCreate = () => {
        setSelected({
            stopId: generateStopId(), // 🔹 auto-generate ID here
            name: '',
            town: '',
            postcode: '',
            location: '',
                            ...
                            {loading ? (
                                ...
                                stops.map((s) => (
                                    <tr key={s._id} className="hover:bg-neutral-900/50">
                                        ...
                                        <td className="px-4 py-3 text-sm truncate max-w-[16rem]">
                                            {(s.routes || []).join(', ') || '—'}
                                        </td>
                        ...
                        <div className="grid gap-4">
                            <label className="grid gap-1">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setSelected((s) => ({ ...s, stopId: e.target.value }))
                                    }
                                    placeholder="Unique Stop ID"
                                />
                            </label>
