    ...
    <div className="max-w-7xl mx-auto py-6 px-4 text-white">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-60 flex-shrink-0">
          <div className="bg-black/80 p-4 rounded-xl sticky top-4 flex flex-row lg:flex-col gap-2 overflow-x-auto md:overflow-visible">
            ...
            <button
              ...
              className="mt-auto lg:mt-4 px-3 py-2 rounded bg-white/10 hover:bg-white/20 flex items-center gap-1 text-sm"
