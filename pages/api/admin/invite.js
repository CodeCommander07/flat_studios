...
export default async function handler(req, res) {
  ...
  try {
    ...
    const inviteUrl = `https://yapton.flatstudios.net/auth/staff/register?email=${encodeURIComponent(
      email
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td align="left" style="vertical-align: middle; width: 50px;">
                <a src="https://yapton.flatstudios.net/cdn/image/logo.png" alt="Yapton & District Logo" style="max-width: 50px; height: auto; margin-right: 10px;" />
              </td>
